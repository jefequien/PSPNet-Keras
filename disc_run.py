...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--category', type=int, required=True, help='Checkpoint to use')
    parser.add_argument('--prediction', type=str, required=True, help='Checkpoint to use')
    parser.add_argument('--checkpoint', type=str, required=True, help='Checkpoint to use')
